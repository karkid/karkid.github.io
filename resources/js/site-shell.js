...
<div class="quick-contact" aria-label="Quick contact links">
    <a href="${linkedIn}" target="_blank" rel="noopener noreferrer" title="LinkedIn" aria-label="LinkedIn"><i class="ion-social-linkedin"></i></a>
    <a href="${github}" target="_blank" rel="noopener noreferrer" title="GitHub" aria-label="GitHub"><i class="ion-social-github"></i></a>
    <a href="${orcid}" target="_blank" rel="noopener noreferrer" title="ORCID iD" aria-label="ORCID iD"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 256 256" aria-hidden="true" style="vertical-align:middle;fill:currentColor"><path d="M128 0C57.3 0 0 57.3 0 128s57.3 128 128 128 128-57.3 128-128S198.7 0 128 0zm-18.5 56.4c5.3 0 9.6 4.3 9.6 9.6s-4.3 9.6-9.6 9.6-9.6-4.3-9.6-9.6 4.3-9.6 9.6-9.6zm-11.4 36.5h22.9V192h-22.9V92.9zm59.9 0h-22.8v99.1h22.8c24.2 0 43.5-10.8 43.5-49.6 0-36.6-18.2-49.5-43.5-49.5zm1.4 79.7h-2.3V112.3h2.3c13.1 0 20.8 7.3 20.8 30.1 0 23-7.7 30.2-20.8 30.2z"/></svg></a>
    <a href="${cv}" target="_blank" rel="noopener noreferrer" title="CV" aria-label="CV"><i class="ion-ios-cloud-download"></i></a>
</div>`;
    };
...
<footer class="site-footer">
    <div class="container footer-row">
        ...
        <p class="footer-links">
            ...
            · <a href="${orcid}" target="_blank" rel="noopener noreferrer">ORCID</a>
            · <a href="${cv}" target="_blank" rel="noopener noreferrer">CV</a>
            · <a href="miscellaneous.html">More about me</a>
        </p>
    </div>
</footer>`;
    };
    ...
    const renderShell = () => {
        ...
        // Note: the page is revealed later, once template-bind.js and
        // theme-toggle.js have also run (see site-bootstrap.js) — otherwise
        // the body would flash with unresolved {Token} text and the light
        // theme before those scripts finish.
    };
